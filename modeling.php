...
<head>
    ...
    <title>Maya Studio | Modeling</title>
...
<div class="ai">
    ...
    <h1 class="wh1">~ MODELING ~</h1>
</div>
    <header class="galheader">
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./modeling.php"><button class="filter-button active">Modeling</button></a>
  ...
  <div class="gallery">
      <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No modeling photos available at the moment.</p>
            </div>
        <?php else: ?>
