...
<div class="ai">
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./child.php"><button class="filter-button active">Child</button></a>
    ...
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No child photos available at the moment.</p>
            </div>
        <?php else: ?>
