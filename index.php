    ...
    <section class="plann" id="plann">
        ...
        <div class="boxx-container">
            <div class="boxx">
                ...
                <h3 class="pricee">15000<span></span></h3>
                ...
                <a href="bookk.php?package=basic"><button class="btnn">Buy Now</button></a>
            </div>

            <div class="boxx">
                <h3 class="titlee">Standard</h3>
                <h3 class="pricee">25000<span></span></h3>
                <h3 class="months">Per Event</h3>
                <ul>
                ...
                <a href="bookk.php?package=standard"><button class="btnn">Buy Now</button></a>
            </div>

            <div class="boxx">
                <h3 class="titlee">Premium</h3>
                <h3 class="pricee">50000<span></span></h3>
                <h3 class="months">Per Event</h3>
                <ul>
                ...
                <a href="bookk.php?package=premium"><button class="btnn">Buy Now</button></a>
            </div>
        </div>
    </section>
