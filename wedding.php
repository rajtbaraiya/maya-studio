...
<head>
    ...
    <title>Maya Studio | Wedding</title>
...
<div class="ai">
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./wedding.php"><button class="filter-button active">Wedding</button></a>
    ...
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No wedding photos available at the moment.</p>
            </div>
        <?php else: ?>
