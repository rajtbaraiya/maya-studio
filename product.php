...
<head>
    ...
    <title>Maya Studio | Product</title>
...
<body>
    <div class="ai">
        ...
        <h1 class="wh1">~ PRODUCT ~</h1>
    </div>

    <header class="pheader"></header>
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./product.php"><button class="filter-button active">Product</button></a>
    ...
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No product photos available at the moment.</p>
            </div>
        <?php else: ?>
