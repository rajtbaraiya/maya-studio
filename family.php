...
<head>
    ...
    <title>Maya Studio | Family</title>
...
<div class="ai">
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./family.php"><button class="filter-button active">Family</button></a>
        </div>
    </div>
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No family photos available at the moment.</p>
            </div>
        <?php else: ?>
