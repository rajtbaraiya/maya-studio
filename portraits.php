...
$category = 'portraits'; // Change this for each category file
$images = [];
...
<head>
    ...
    <title>CODE-WITH-HIRAJAT | PORTRAITS PAGE</title>
    ...
    <style>
        ...
        *{
        ...
        .mheader
        {
            ...
            url(assets/images/portraitsplogo.JPG);
...
<body>
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./portraits.php"><button class="filter-button active">Portraits</button></a>
    ...
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No portraits available at the moment.</p>
            </div>
        <?php else: ?>
