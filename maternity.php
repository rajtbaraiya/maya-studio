...
<head>
    ...
    <title>CODE-WITH-HIRAJAT | MATERNITY PAGE</title>
...
<body>
    ...
    <div class="filter-container">
        ...
        <div class="filter-buttons" id="filterButtons">
            ...
            <a href="./maternity.php"><button class="filter-button active">Maternity</button></a>
    ...
    <div class="gallery">
        <?php if (empty($images)): ?>
            <div class="no-images">
                <p>No maternity photos available at the moment.</p>
            </div>
        <?php else: ?>
