...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['selected_photos'])) {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            $success = "Your photo request has been submitted to admin! We'll notify you once it's approved.";
        } else {
...
<head>
    ...
    <title>Select Photos for Admin - Maya Studio</title>
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="" id="photoRequestForm">
